package com.example.phuongquy.leaseLover.Fragment;
...
import com.example.phuongquy.leaseLover.adapter.Info_Nu_adapter;
import com.example.phuongquy.leaseLover.model.Info_Nu;
...
public class HomeFragment extends Fragment {
    ...
    ArrayList<Info_Nu> manginfo = new ArrayList<>();
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(server.info_nu, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if(response!=null){
                    ...
                    info_nu_adapter.notifyDataSetChanged();
                }
            }
